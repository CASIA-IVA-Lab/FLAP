...
run_python_command () {
    ...
    --structure $5 \
    --nsamples 1024 \
    --save_model "llm_weights/${1}_p${2}_${4}_${5}_llama_13b/" \
    --eval \
    --unstr
}

# llama-13b with flap pruning method (p=0.2/0.3/0.5, adaptive in all layers)
...
# llama-13b with wanda-sp pruning method (p=0.2/0.3/0.5, uniform in all layers)
...
# # llama-13b with mag-sp pruning method (p=0.2/0.3/0.5, uniform in all layers)
